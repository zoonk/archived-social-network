...
const translate: TranslationFn = (key, args) => {
  const data: TranslationData = {
    ...
    no_chapters: `Os capítulos têm lições para ensinar um assunto. Ajude mais pessoas a aprenderem sobre **${args?.title}**. [Crie o primeiro capítulo](/chapters/add?topicId=${args?.id}).`,
    ...
    no_lessons: `Seja o primeiro a [criar uma lição](/posts/add?category=lessons&topicId=${args?.topicId}&chapterId=${args?.chapterId}) e ajude outras pessoas a aprenderem sobre **${args?.title}**.`,
