...
const translate: TranslationFn = (key, args) => {
  const data: TranslationData = {
    ...
    next: 'Próxima',
    no_books: `Leu algum livro interessante sobre ${args?.title}?`,
    ...
    no_courses: `Conhece algum curso bom sobre ${args?.title}? Ajude outras pessoas a encontrá-lo.`,
    no_examples: `Por que é importante aprender sobre ${args?.title}? Seja a primeira pessoa a mostrar um exemplo prático.`,
    no_lessons: `Ajude outras pessoas a aprenderem sobre ${args?.title}.`,
    no_posts: `Tem alguma opinião ou experiência sobre ${args?.title}? Não guarde para você.`,
    no_questions: `Tem alguma dúvida sobre ${args?.title}?`,
    no_references: `Achou um link ou referência legal sobre ${args?.title}? Não guarde para você.`,
